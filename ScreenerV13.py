...
# Prevent white flash on auto-refresh rerun
st.markdown(
    """<style>
    ...
    /* Keep content visible during rerun */
    [data-testid="stApp"] > div { opacity: 1 !important; }
    </style>""",
...
AUTO_REFRESH_INTERVAL = int(
    os.environ.get("AUTO_REFRESH_INTERVAL", "60")
...
def screening_page():
    ...
    if st.session_state.get("background_refresh", False):
        ...
        if results:
            ...
            st.session_state.last_refresh_time = now_ist()
